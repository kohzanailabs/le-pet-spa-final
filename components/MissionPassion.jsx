        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-stretch">
          ...
          >
            <div className="relative group">
              <div className="relative aspect-video overflow-hidden shadow-2xl boutique-border" style={{ borderRadius: '40px' }}>
                <Image
                  src="/mission.png"
            ...
            <div className="px-4">
              <h2 className="text-5xl md:text-6xl font-black text-[#111111] mb-6 tracking-tighter leading-none">
                Our <span className="text-gradient-gold">Mission</span>
              </h2>
              <p className="text-xl text-[#111111] font-medium leading-relaxed opacity-90">
